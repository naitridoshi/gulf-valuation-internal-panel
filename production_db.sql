...
CREATE TABLE `valuations` (
  ...
  `invoice_amount` decimal(10,3) DEFAULT NULL,
  `invoice_vat` decimal(10,3) DEFAULT NULL,
  `invoice_total` decimal(10,3) DEFAULT NULL,
