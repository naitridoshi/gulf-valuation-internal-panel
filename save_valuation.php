...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $year_of_manufacture = (int)($_POST['year_of_manufacture'] ?? 0);
    ...
    $forced_sale_valuation_amount = !empty($_POST['forced_sale_valuation_amount'])
        ...
        : null;
    $invoice_amount = isset($_POST['invoice_amount']) && $_POST['invoice_amount'] !== '' ? (float)$_POST['invoice_amount'] : 0.0;
    ...
    if ($engine_number === '') $errors[] = 'Engine Number is required.';
